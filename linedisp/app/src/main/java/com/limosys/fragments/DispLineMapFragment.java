...
import com.limosys.views.CustomInfoBox;
import com.limosys.views.DispLineFAB;
import com.limosys.views.ListOfActionsDialogView;
...
public class DispLineMapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public CustomInfoBox getCurrentInfoBox() {
    ...
    private CustomInfoBox currentInfoBox;
...
//                }
//
//                new ListOfActionsDialogView(getContext(), new ListOfActionsDialogView.ActionDialogCallback() {
//                    @Override
//                    public void onActionClicked(ActionDialogView.InfoDialogType type) {
//
//                        ActionDialogView dialog = new ActionDialogView(getContext(), type, String.valueOf(getCurrentInfoBox().getLineCarsRequired()),
//                                String.valueOf((int) getCurrentInfoBox().getLineIncentive()), getCurrentInfoBox().getLineDescription());
//
...
//        });
    ...
    private CustomInfoBox showLineOnMap(Ws_GetLineInfoDispatcherResult line) {

        if (line == null && line.getName() == null) ((DispLineActivity) getActivity()).logOut();

        map.clear();

        CustomInfoBox infoBox = new CustomInfoBox(getActivity(), line);
